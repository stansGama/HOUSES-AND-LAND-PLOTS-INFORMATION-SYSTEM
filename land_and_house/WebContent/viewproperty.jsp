...
response.sendRedirect("/land_and_house/user/viewproperty.jsp?id="+request.getParameter("id"));
}else{
response.sendRedirect("/land_and_house/user/");
}
}else{
if(request.getParameter("id") == null){
response.sendRedirect("/land_and_house/");
}else{
	...
	<div class="container">
		<div id="row1" class="row justify-content-center">
			...
			<div class="row col-12">
				...
				<div class="property-info col-12 col-md-5">
				...
				<!-- image div starts -->
				<div class="property-info col-12 col-md-7">
					...
					<div class="img-div col-12">
						...
						<span class="col-12"><% out.print(pic.getValue()[1]); %></span>
					</div>
					<%} %>
				<!-- <div class="img-div col-12">
